          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <ScrollReveal delay={0.2}>
              <div className="flex flex-wrap gap-3 mt-8">
                ...
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=info@kitiibwasafaris.com&su=Kitiibwa%20Safaris%20Inquiry"
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  title="Send an email to info@kitiibwasafaris.com"
                >
                ...
                <ScrollReveal delay={0.1}>
                  <div className="bg-card rounded-2xl p-8 md:p-10 shadow-xl border border-border">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      {/* Send Message */}
                      <a
                        href={`https://mail.google.com/mail/?view=cm&fs=1&to=info@kitiibwasafaris.com&su=${encodeURIComponent(formData.subject || 'Kitiibwa Safaris inquiry')}&body=${encodeURIComponent(`Hello Kitiibwa Safaris,\n\nName: ${formData.name}\nEmail: ${formData.email}\nPhone: ${formData.phone}\n\n${formData.message}`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
