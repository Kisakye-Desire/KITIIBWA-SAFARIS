            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              {status === 'error' && (
                <div role="alert" className="rounded-lg border border-accent/30 bg-accent/10 p-4 text-sm text-foreground">
                  ...
                  <p className="mt-3">You can still donate via Airtel Money <strong>0702 345273</strong> or MTN Mobile Money <strong>0773 525452</strong>, both registered to Muwaga Hannington.</p>
                </div>
              )}
